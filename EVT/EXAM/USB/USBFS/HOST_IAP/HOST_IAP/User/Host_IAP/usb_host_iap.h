...
extern __attribute__((aligned(4))) uint8_t  USBFS_TX_Buf[ MAX_PACKET_SIZE ] ;  // IN, must even address
extern __attribute__((aligned(4))) uint8_t  USBFS_RX_Buf_RX_Buf[ MAX_PACKET_SIZE ] ;  // OUT, must even address
