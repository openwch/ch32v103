...
void USBFS_Device_Endp_Init(void)
{
    ...
    R16_UEP3_DMA = (uint16_t)(uint32_t)USBFS_EP3_Buf;
    R16_UEP4_DMA = (uint16_t)(uint32_t)USBFS_EP4_Buf;

    R16_UEP5_DMA = (uint16_t)(uint32_t)USBFS_EP5_Buf;
    R16_UEP6_DMA = (uint16_t)(uint32_t)USBFS_EP6_Buf;
