...
#define DEF_USBD_UEP0_SIZE            8     /* usbfs full speed device end-point 0 size */
/* FS */
#define DEF_USBD_FS_PACK_SIZE         64     /* usbfs full speed device max bluk/int pack size */
#define DEF_USBD_FS_ISO_PACK_SIZE     1023   /* usbfs full speed device max iso pack size */
/* LS */
#define DEf_USBD_LS_UEP0_SIZE         8      /* usbfs low speed device end-point 0 size */
#define DEF_USBD_LS_PACK_SIZE         8     /* usbfs low speed device max int pack size */
...
/* LS */
#define DEF_USBD_EP1_LS_SIZE          DEF_USBD_LS_PACK_SIZE
#define DEF_USBD_EP2_LS_SIZE          DEF_USBD_LS_PACK_SIZE
#define DEF_USBD_EP3_LS_SIZE          DEF_USBD_LS_PACK_SIZE
#define DEF_USBD_EP4_LS_SIZE          DEF_USBD_LS_PACK_SIZE
#define DEF_USBD_EP5_LS_SIZE          DEF_USBD_LS_PACK_SIZE
#define DEF_USBD_EP6_LS_SIZE          DEF_USBD_LS_PACK_SIZE
/* ... */
