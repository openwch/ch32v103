/********************************** (C) COPYRIGHT  *******************************
 * File Name          : ch32v10x_usbfs_host.h
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2020/04/30
 * Description        :
...
#ifndef __CH32V10x_USBFS_RX_Buf_HOST_H
#define __CH32V10x_USBFS_RX_Buf_HOST_H
...
/* USB Buffer Size */
#ifndef USBFS_RX_Buf_MAX_PACKET_SIZE
#define USBFS_RX_Buf_MAX_PACKET_SIZE      64
#endif
...
extern __attribute__((aligned(4))) uint8_t  USBFS_RX_Buf_RX_Buf[ ];
