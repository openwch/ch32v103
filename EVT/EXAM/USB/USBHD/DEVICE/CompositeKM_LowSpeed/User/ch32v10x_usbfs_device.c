...
/* Endpoint Buffer */
__attribute__ ((aligned(4))) uint8_t USBHD_EP0_Buf[ DEF_USBD_UEP0_SIZE ];     //ep0(8)
__attribute__ ((aligned(4))) uint8_t USBHD_EP1_Buf[ DEF_USBD_EP1_LS_SIZE ];    //ep1_in(8)
__attribute__ ((aligned(4))) uint8_t USBHD_EP2_Buf[ DEF_USBD_EP2_LS_SIZE ];    //ep2_in(8)
