...
extern __attribute__ ((aligned(4))) uint8_t USBHD_EP3_Buf[ ];
extern __attribute__ ((aligned(4))) uint8_t USBHD_EP4_Buf[ ];
extern __attribute__ ((aligned(4))) uint8_t USBHD_EP5_Buf[ ];
extern __attribute__ ((aligned(4))) uint8_t USBHD_EP6_Buf[ ];
