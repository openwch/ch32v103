 ...
 *@Note
  ...
  USBFS HOST USB drive enumeration and operation, read the APP.BIN file in the root directory inside the USB drive, write to location 0x08008000, after a successful check
