...
/*
 *@Note
 *External trigger starts two timer routines synchronously:
 *TIM1_CH1(PA8)
 *This example demonstrates the TIM_CH1(PA8) pin pull-up input, the pin detects
 *a rising edge, then starts TIM1 and TIM2.
 *
 */
