 ...
 *This example demonstrates three complementary output modes with dead zone of TIM1:
 *complementary output with dead zone insertion, dead zone waveform delay Greater than
 *the negative pulse, the dead zone waveform delay is greater than the positive pulse.
 *
 */
