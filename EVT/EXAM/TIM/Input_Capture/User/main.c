 ...
 *edge transition to trigger a TIM1 capture interrupt,
 *The rising edge triggers the TIM_IT_CC1 interrupt, and the falling edge triggers
 *the TIM_IT_CC2 interrupt.
 *
 */
