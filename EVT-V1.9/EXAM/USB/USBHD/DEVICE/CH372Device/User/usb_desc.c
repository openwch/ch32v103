...
{
    0x12, 0x01, 0x10, 0x01, 0xFF, 0x80, 0x55, DEF_USBD_UEP0_SIZE,
    (uint8_t)(DEF_USB_VID&0xFF), (uint8_t)(DEF_USB_VID>>8),
    (uint8_t)(DEF_USB_PID&0xFF), (uint8_t)(DEF_USB_PID>>8),
    0x00, DEF_IC_PRG_VER, 0x01, 0x02, 0x00, 0x01,
};
...
{
        0x12, 0x03, 'C', 0, 'H', 0, '3', 0, '2', 0, 'V', 0, '2', 0
                  , '0', 0, 'x', 0
};
